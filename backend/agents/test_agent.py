"""test_agent — the test coverage specialist.

Reviews diffs for test issues: missing tests, inadequate coverage,
test quality, and test anti-patterns.
"""
...
class TestAgent(BaseAgent):
    """The test coverage specialist agent."""
